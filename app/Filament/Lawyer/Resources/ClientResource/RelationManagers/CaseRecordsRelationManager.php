...
namespace App\Filament\Lawyer\Resources\ClientResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ViewAction::make()
                    ->url(fn($record) => \App\Filament\Lawyer\Resources\CaseResource::getUrl('view', ['record' => $record])),
