...
namespace App\Filament\SubLawyer\Resources\CaseResource\Pages;

use App\Filament\SubLawyer\Resources\CaseResource;
...
class CreateCase extends CreateRecord
{
    ...
    {
        if (request()->has('client_id')) {
            return \App\Filament\SubLawyer\Resources\ClientResource::getUrl('view', ['record' => request('client_id')]);
        }
