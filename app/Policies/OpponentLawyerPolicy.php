...
class OpponentLawyerPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, OpponentLawyer $opponentlawyer): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, OpponentLawyer $opponentlawyer): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, OpponentLawyer $opponentlawyer): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, OpponentLawyer $opponentlawyer): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, OpponentLawyer $opponentlawyer): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, OpponentLawyer $opponentlawyer): bool
    {
