...
class ReminderLogPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, ReminderLog $reminderlog): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, ReminderLog $reminderlog): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, ReminderLog $reminderlog): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, ReminderLog $reminderlog): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, ReminderLog $reminderlog): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, ReminderLog $reminderlog): bool
    {
