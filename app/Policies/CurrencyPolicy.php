...
class CurrencyPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Currency $currency): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Currency $currency): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Currency $currency): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Currency $currency): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Currency $currency): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Currency $currency): bool
    {
