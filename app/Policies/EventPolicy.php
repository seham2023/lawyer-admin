...
class EventPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Event $event): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Event $event): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Event $event): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Event $event): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Event $event): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Event $event): bool
    {
