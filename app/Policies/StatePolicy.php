...
class StatePolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, State $state): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, State $state): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, State $state): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, State $state): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, State $state): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, State $state): bool
    {
