...
class RolePolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Role $role): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Role $role): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Role $role): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Role $role): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Role $role): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Role $role): bool
    {
