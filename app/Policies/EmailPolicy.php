...
class EmailPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Email $email): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Email $email): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Email $email): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Email $email): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Email $email): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Email $email): bool
    {
