...
class ExpenseCheckPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, ExpenseCheck $expensecheck): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, ExpenseCheck $expensecheck): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, ExpenseCheck $expensecheck): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, ExpenseCheck $expensecheck): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, ExpenseCheck $expensecheck): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, ExpenseCheck $expensecheck): bool
    {
