...
class NotePolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Note $note): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Note $note): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Note $note): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Note $note): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Note $note): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Note $note): bool
    {
