...
class PaymentSessionPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, PaymentSession $paymentsession): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, PaymentSession $paymentsession): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, PaymentSession $paymentsession): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, PaymentSession $paymentsession): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, PaymentSession $paymentsession): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, PaymentSession $paymentsession): bool
    {
