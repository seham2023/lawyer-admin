...
class StatusPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Status $status): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Status $status): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Status $status): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Status $status): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Status $status): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Status $status): bool
    {
