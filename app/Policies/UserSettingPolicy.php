...
class UserSettingPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, UserSetting $usersetting): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, UserSetting $usersetting): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, UserSetting $usersetting): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, UserSetting $usersetting): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, UserSetting $usersetting): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, UserSetting $usersetting): bool
    {
