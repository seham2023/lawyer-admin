...
class LevelPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Level $level): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Level $level): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Level $level): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Level $level): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Level $level): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Level $level): bool
    {
