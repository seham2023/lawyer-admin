...
class AddressPolicy
{
     ...
     */
    public function view(App\Models\Qestass\User $user, Address $address): bool
    {
     ...
     */
    public function update(App\Models\Qestass\User $user, Address $address): bool
    {
     ...
     */
    public function delete(App\Models\Qestass\User $user, Address $address): bool
    {
     ...
     */
    public function restore(App\Models\Qestass\User $user, Address $address): bool
    {
     ...
     */
    public function replicate(App\Models\Qestass\User $user, Address $address): bool
    {
     ...
     */
    public function forceDelete(App\Models\Qestass\User $user, Address $address): bool
    {
